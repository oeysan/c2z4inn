...
<article id="csl-bib-container-26JIB89K" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-26JIB89K" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-26JIB89K" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-26JIB89K" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#contributors-article-26JIB89K" alt="contributors" class="csl-bib-button">Medverkande</a>
    <a href="#sdg-article-26JIB89K" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-26JIB89K" class="csl-bib-meta">
  <article id="about-article-26JIB89K" class="about_pub-article">
    <h1>Om</h1>
    Skille et al. gjennomførte ein studie for å forstå korleis norske statlege idrettspolitikkar vert implementerte i lokale idrettslag. Dei nytta undersøkingar og intervju for å utforske korleis lokale idrettsråd og lag oppfattar dei lokale aktivitetsmidlane (LAM), som vert administrerte av Kulturdepartementet og direkte støttar lokale idrettsaktivitetar. Funnene viser at både råda og laga meiner LAM-systemet fungerer godt, med råda som særleg positive. I tillegg antydar studien at effektiviteten til LAM-systemet har betra seg over åra. Forfattarane diskuterer korleis økonomiske tilskot bidreg til å oppnå det breiare politiske målet om å fremje idrett og fysisk aktivitet for alle. Denne forskinga er viktig fordi ho framhevar den vellykka implementeringa av politikkar som har som mål å auke deltakinga i samfunnsidrett.
  </article>
  <article id="keywords-article-26JIB89K" class="keywords-article">
    <h1>Emneord</h1>
    Norsk idrettspolitikk, Lokale aktivitetsmidlar, Idrettslag, Implementering, Kulturdepartementet
  </article>
