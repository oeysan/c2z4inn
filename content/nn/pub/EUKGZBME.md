...
<article id="csl-bib-container-EUKGZBME" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-EUKGZBME" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-EUKGZBME" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-EUKGZBME" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#contributors-article-EUKGZBME" alt="contributors" class="csl-bib-button">Medverkande</a>
    <a href="#sdg-article-EUKGZBME" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-EUKGZBME" class="csl-bib-meta">
  <article id="about-article-EUKGZBME" class="about_pub-article">
    <h1>Om</h1>
    Stenling et al. gjennomførte ein studie om korleis nominasjonskomitear (NC) i svenske nasjonale idrettsorganisasjonar påverkar utveljinga av styremedlemmer. Dei intervjua NC frå 64 organisasjonar og identifiserte seks viktige steg i nominasjonsprosessen: val av NC, overvaking av det noverande styret, førebuing til å identifisere kandidatar, oppretting av ei liste over potensielle kandidatar, evaluering av desse kandidatane, og innsending av den endelege lista til generalforsamlinga. Studien fann at tre faktorar—formalisering (kor strukturert prosessen er), nettverksavhengigheit (bruk av personlege forbindelsar), og openheit—har vesentleg innverknad på styresamansetninga. Desse funna er viktige fordi dei framhevar korleis NC kan forme effektiviteten og representasjonen av styra i idrettsorganisasjonar, og gir innsikt for framtidig forsking og praktiske forbetringar i styring.
  </article>
  <article id="keywords-article-EUKGZBME" class="keywords-article">
    <h1>Emneord</h1>
    Nominasjonskomitear, Styresamansetning, Idrettsorganisasjonar, Styring, Svenske nasjonale idrettsorganisasjonar
  </article>
