...
<article id="csl-bib-container-G4XZLGSZ" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-G4XZLGSZ" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-G4XZLGSZ" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-G4XZLGSZ" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#sdg-article-G4XZLGSZ" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-G4XZLGSZ" class="csl-bib-meta">
  <article id="about-article-G4XZLGSZ" class="about_pub-article">
    <h1>Om</h1>
    Jørgensen et al. utforskar korleis forretningsmodellar innan detaljhandel utviklar seg på grunn av auka fokus på berekraft, digitalisering og endra kundepreferansar. Dei argumenterer for at for å møte ambisiøse berekraftsmål, må selskap ta i bruk sirkulære forretningsmodellar. Dette inneber å gå bort frå ein "ta, lag, kast"-tilnærming til ein som vektlegg resirkulering, gjenbruk av materialar og tenestebasert forbruk. Forfattarane diskuterer nødvendige endringar på system-, selskaps- og individnivå for å støtte desse modellane. Dei framhevar også praktiske utfordringar ved å bruke innsikt frå eit forskingsprosjekt om sirkulære forretningsmodellar og grønt forbrukaråtferd hos Orkla Home & Personal Care. Denne studien gir verdifull forståing av vanskane og moglegheitene ved å gå over til meir berekraftige praksisar innan detaljhandel.
  </article>
