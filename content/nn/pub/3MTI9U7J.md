...
<article id="csl-bib-container-3MTI9U7J" class="csl-bib-container">
  <div class="csl-bib-body"> <div class="csl-entry">Lie, S., Vegge, T., &#38; Sandhaug, C. (Red.). (2020). <i>The Mimesis of Change: Conversion and Peripety in Life Stories</i>. Fabrizio Serra Editore.</div> </div>
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-3MTI9U7J" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-3MTI9U7J" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-3MTI9U7J" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#contributors-article-3MTI9U7J" alt="contributors" class="csl-bib-button">Medverkande</a>
    <a href="#sdg-article-3MTI9U7J" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
  </div>
...
<div id="csl-bib-meta-3MTI9U7J" class="csl-bib-meta">
  <article id="about-article-3MTI9U7J" class="about_pub-article">
    <h1>Om</h1>
    Lie et al. utforskar korleis forteljingar om betydningsfulle livsendringar, kjent som "peripeti," kan påverke publikum. Denne boka undersøker korleis narrativ om heltar og framståande personar ofte inkluderer dramatiske vendepunkt eller omslag, og lærer lesarar eller sjåarar å lære av karakterane sine feil. Desse forteljingane kan inspirere til personleg transformasjon, anten gjennom individuelle val eller ytre hendingar. Forfattarane analyserer ulike former for forteljing, inkludert brev, forteljingar, sjølvbiografiar, poesi, måleri og teater, for å vise korleis desse endringane blir skildra. Studiet legg vekt på mottakinga hos publikum, og antyder at det å vere vitne til desse endringane kan føre til personleg refleksjon og transformasjon, anten gjennom å erkjenne eigne feil eller kjenne lettelse ved å unngå liknande feil. Dette verket framhevar forteljingas kraft til å fremje endring og vekst.
  </article>
  <article id="keywords-article-3MTI9U7J" class="keywords-article">
    <h1>Emneord</h1>
    Mimesis, Endring, Konversjon, Peripeti, Livshistorier, Forteljingar, Resepsjon
  </article>
  ...
  <article id="taxonomy-article-3MTI9U7J" class="taxonomy-article">
    ...
    <ul>
      ...
      <li><a href="{{< params subfolder >}}nn/archive/?key=KUYZ6YP4">September</a></li>
    </ul>
  </article>
</div>
