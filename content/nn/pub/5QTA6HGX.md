...
<article id="csl-bib-container-5QTA6HGX" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-5QTA6HGX" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-5QTA6HGX" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-5QTA6HGX" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#sdg-article-5QTA6HGX" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-5QTA6HGX" class="csl-bib-meta">
  <article id="about-article-5QTA6HGX" class="about_pub-article">
    <h1>Om</h1>
    Zuza et al. gjennomførte ein studie for å føreseie korleis klimaendringar vil påverke dyrkinga av makadamianøtter i Malawi. Makadamia er ein viktig avling for landet og gir betydeleg inntekt. Ved bruk av klimamodellar fann dei at for tida er 57% av Malawi eigna for dyrking av makadamia. Men innan 2050-talet kan klimaendringar redusere dette eigna området med opptil 21,6%, spesielt i dei sørlege og sentrale regionane. Den nordlege regionen vil bli mindre påverka. Viktige faktorar som påverkar eignaheit inkluderer nedbør i den tørreste månaden og temperaturstabilitet. Denne forskinga understrekar behovet for målretta strategiar for å hjelpe bønder med å tilpasse seg endra forhold og sikre fortsatt produksjon av makadamia.
  </article>
  <article id="keywords-article-5QTA6HGX" class="keywords-article">
    <h1>Emneord</h1>
    Klimaendringar, Makadamiadyrking, Klimatilpassing, Malawi, Representative konsentrasjonsbanar, Nedbør, Isotermalitet
  </article>
  ...
  <article id="taxonomy-article-5QTA6HGX" class="taxonomy-article">
    ...
    <ul>
      ...
      <li><a href="{{< params subfolder >}}nn/archive/?key=L3XFEFYE">September</a></li>
    </ul>
  </article>
</div>
