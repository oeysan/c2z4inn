...
<article id="csl-bib-container-WQ8P7QFX" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-WQ8P7QFX" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-WQ8P7QFX" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-WQ8P7QFX" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#contributors-article-WQ8P7QFX" alt="contributors" class="csl-bib-button">Medverkande</a>
    <a href="#sdg-article-WQ8P7QFX" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-WQ8P7QFX" class="csl-bib-meta">
  <article id="about-article-WQ8P7QFX" class="about_pub-article">
    <h1>Om</h1>
    Hovland et al. gjennomførte ein studie for å forstå korleis unge vaksne med alvorleg psykisk liding (SMI) opplever fysisk aktivitet og dens påverknad på helse og velvære. Dei intervjua ni deltakarar som hadde delteke i høgintensitets aerob trening. Funna viste at fysisk aktivitet blir sett på som meiningsfull og fordelaktig, og at den aukar velvære og helse. Likevel krev det sosial støtte og oppmuntring for å overvinne hindringar. Tre hovudtema kom fram: fysisk aktivitet forbetrar fokus og velvære, styrkar mental styrke, og blir hindra av mangel på støtte og tryggleik. Studien konkluderer med at tilpassa fysisk aktivitet kan styrke sjølvidentitet, mental velvære og sosialt engasjement, og hjelpe individ med å handtere stress betre. Å velje aktivitetar basert på personleg interesse er avgjerande for vedvarande engasjement og livsendringar.
  </article>
  <article id="keywords-article-WQ8P7QFX" class="keywords-article">
    <h1>Emneord</h1>
    Fysisk aktivitet, Helse, Velvære, Alvorleg psykisk liding, Sosial støtte, Aerob høgintensitets intervalltrening
  </article>
...
This study shows that adapted physical activity is an important resistance resource that can promote stronger self-identity, increased mental well-being and social engagement and thus contribute to an improved ability to manage stressors. Furthermore, the findings reveal that to engage in physical activity and promote sustainable life changes, it is important for individuals to choose a physical activity based on personal interest and meaning.
  ...
  <article id="taxonomy-article-WQ8P7QFX" class="taxonomy-article">
    ...
    <ul>
      ...
      <li>
        <a href="/nn/archive/?key=9SDSCW3J">Juni</a>
      </li>
    </ul>
    <ul>
      <li>
