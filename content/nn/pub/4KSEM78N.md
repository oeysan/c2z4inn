...
<article id="csl-bib-container-4KSEM78N" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-4KSEM78N" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-4KSEM78N" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-4KSEM78N" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#contributors-article-4KSEM78N" alt="contributors" class="csl-bib-button">Medverkande</a>
    <a href="#sdg-article-4KSEM78N" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-4KSEM78N" class="csl-bib-meta">
  <article id="about-article-4KSEM78N" class="about_pub-article">
    <h1>Om</h1>
    Molander og Wennberg gjennomførte ein studie for å evaluere tre verktøy som blir brukt til å måle problemspeling: Problem Gambling Severity Index (PGSI), Problem and Pathological Gambling Measure (PPGM), og NORC Diagnostic Screen for Gambling Problems (NODS). Dei analyserte data frå 598 deltakarar, inkludert dei som søkte hjelp og rekreasjonsspelarar. Funna deira viste at PGSI var mindre effektiv til å identifisere speleproblem med låg alvorlegheitsgrad samanlikna med dei andre verktøya. PPGM vart funne å vere det mest pålitelege for å oppdage eit breitt spekter av speleproblem både i generelle og kliniske settingar. NODS var best eigna til å identifisere alvorlege speleproblem i kliniske prøver. Denne forskinga bidreg til å forbetre nøyaktigheita i diagnostiseringa av speleproblem, noko som er viktig for å gi riktig støtte og behandling.
  </article>
  <article id="keywords-article-4KSEM78N" class="keywords-article">
    <h1>Emneord</h1>
    Problemspeling, Psykometriske eigenskapar, Spelverktøy, PGSI, PPGM, NODS
  </article>
