...
<article id="csl-bib-container-PFCN5UXT" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-PFCN5UXT" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-PFCN5UXT" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-PFCN5UXT" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#sdg-article-PFCN5UXT" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-PFCN5UXT" class="csl-bib-meta">
  <article id="about-article-PFCN5UXT" class="about_pub-article">
    <h1>Om</h1>
    Alehagen et al. gjennomførte ein studie i Sverige for å undersøke om inntak av selen og koenzym Q10-supplement kunne forbetre hjartehelsa hos eldre med låge selen-nivå. Over fire år tok 443 deltakarar anten supplementa eller placebo. Forskarane fann at dei som tok supplementa hadde betre hjartefunksjon, mindre hjartestress og lågare dødsratar relatert til hjartesjukdom sjølv 12 år seinare. Dei nytta ein metode kalla strukturell likningsmodellering for å vise at supplementa reduserte inflammasjon og oksidativt stress, som igjen reduserte skade på hjartemuskelen og forbetra hjartemuskelfunksjonen. Dette tyder på at selen og koenzym Q10 kan vere viktige for hjartehelsa, spesielt hos personar med låge selen-nivå.
  </article>
  <article id="keywords-article-PFCN5UXT" class="keywords-article">
    <h1>Emneord</h1>
    Selen-supplementering, Koenzym Q10, Kardiovaskulær helse, Inflammasjon, Oksidativt stress, Biomarkørar
  </article>
