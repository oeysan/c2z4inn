...
<article id="csl-bib-container-7EI3F3JK" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-7EI3F3JK" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-7EI3F3JK" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-7EI3F3JK" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#sdg-article-7EI3F3JK" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-7EI3F3JK" class="csl-bib-meta">
  <article id="about-article-7EI3F3JK" class="about_pub-article">
    <h1>Om</h1>
    Ferguson-Cradler utforskar korleis overgangen til ei verd med nullutslepp krev store endringar i korleis økonomiar er strukturerte. Dei framhevar viktigheita av å forstå kven som kontrollerer ressursar og profitt i denne grøne overgangen, då det vil påverke framtidige politiske økonomiar. Artikkelen føreslår at idear frå tidleg 1900-tals amerikansk institusjonalisme kan veilede forskarar, aktivistar og politikkutformarar i å forme energiovergangar. Den identifiserer tre viktige innsikter: for det første oppmuntrar institusjonalisme til kreativ tenking om organisering av forretningsaktivitetar utover enkle offentleg-private skilje. For det andre trekkjer den parallellar mellom idear frå New Deal-æraen og dagens miljø-, sosiale og styringsprinsipp (ESG). Til sist diskuterer den radikale idear frå institusjonalisten Adolf Berle om å transformere privat eigedom og investering for å takle klima- og ulikskapsutfordringar samtidig.
  </article>
  <article id="keywords-article-7EI3F3JK" class="keywords-article">
    <h1>Emneord</h1>
    Nullutslepp, Energiovergang, Politiske økonomiar, Teknologiske infrastrukturar, ESG-prinsipp, Privat eigedom, Investering
  </article>
