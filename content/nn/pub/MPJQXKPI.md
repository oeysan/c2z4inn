---
title: Arbetsförhållanden och välbefinnande i arbetet inom den svenska Försvarsmakten
type: pub
encoding: UTF-8

---
<h1>Publikasjon</h1>
<article id="csl-bib-container-MPJQXKPI" class="csl-bib-container">
  <div class="csl-bib-body"> <div class="csl-entry">Österberg, J., &#38; Rydstedt, L. W. (2024). Arbetsförhållanden och välbefinnande i arbetet inom den svenska Försvarsmakten. <i>Arbetsmarknad &#38; Arbetsliv</i>, <i>30</i>(1), 25–39. <a href="https://doi.org/10.58236/aa.25473">https://doi.org/10.58236/aa.25473</a></div> </div>
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-MPJQXKPI" alt="archive" class="csl-bib-button">Arkiv</a>
    <a href="https://app.cristin.no/results/show.jsf?id=2261014" alt="Cristin" class="csl-bib-button">Cristin</a>
    <a href="http://zotero.org/groups/5881554/items/MPJQXKPI" alt="Zotero" class="csl-bib-button">Zotero</a>
    <a href="#keywords-article-MPJQXKPI" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-MPJQXKPI" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#contributors-article-MPJQXKPI" alt="contributors" class="csl-bib-button">Medverkande</a>
    <a href="#sdg-article-MPJQXKPI" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
    <a href="https://journals.lub.lu.se/aoa/article/download/25473/22970" alt="Unpaywall" class="csl-bib-button">Unpaywall</a>
    <a href="https://journals.lub.lu.se/aoa/article/download/25473/22970" alt="EZproxy" class="csl-bib-button">EZproxy</a>
  </div>
  <div id="csl-bib-meta-container-MPJQXKPI"></div>
</article>
<div id="csl-bib-meta-MPJQXKPI" class="csl-bib-meta">
  <article id="about-article-MPJQXKPI" class="about_pub-article">
    <h1>Om</h1>
    Österberg og Rydstedt gjennomførte ei undersøking for å forstå korleis arbeidskrav, støtte, ressursar og konfliktar mellom arbeid og privatliv påverkar velværet til svensk militærpersonell. Dei undersøkte 1002 offiserar og spesialistoffiserar, med ein gjennomsnittsalder på 41 år. Ved bruk av statistisk analyse fann dei at høge arbeidskrav var sterkt knytt til lågare velvære på arbeidsplassen. Derimot var det å ha støtte og ressursar frå organisasjonen og næraste overordna sterkt knytt til høgare velvære. I tillegg reduserte konfliktar mellom arbeid og privatliv rapportert velvære betydeleg. Desse funna understrekar viktigheita av å handtere arbeidskrav og gi tilstrekkeleg støtte for å betre velværet til militærpersonell.
  </article>
  <article id="keywords-article-MPJQXKPI" class="keywords-article">
    <h1>Emneord</h1>
    Arbeidsforhold, Velvære, Svenske Forsvaret, Jobbkrav, Organisatorisk støtte, Arbeidslivskonflikt
  </article>
  <article id="abstract-article-MPJQXKPI" class="abstract-article">
    <h1>Samandrag</h1>
    Syftet med denna survey-studie med tvärsnitts-design var att belysa hur arbetskrav, 
stöd och resurser, samt konflikter mellan arbete – övrigt liv relaterade till 
välbefinnande i arbetet för svenska miliärer. Undersökningsgruppen bestod 
av 1002 svenska anställda officerare och specialistofficerare (ålder m=41; 90 
procent män/ 10 procent kvinnor). För den statistiska analysen användes 
hierarkisk multipel regressionsanalys. Efter kontroll för demografiska bakgrundsfaktorer 
introducerades arbetsinnehållet, där upplevt höga arbetskrav 
relaterade starkt negativt - medan resurser och stöd från organisationen/ 
närmaste chef relaterade starkt positivt – till arbetsrelaterat välbefinnande. 
Slutligen introducerades konflikter mellan arbete och övrigt liv, vilket 
relaterade signifikant negativt till rapporterat arbetsrelaterat välbefinnande.
  </article>
  <article id="contributors-article-MPJQXKPI" class="contributors-article">
    <h1>Medverkande</h1>
  ...
  <article id="sdg-article-MPJQXKPI" class="sdg-article">
    <h1>Berekraftsmål</h1>
  ...
  <article id="taxonomy-article-MPJQXKPI" class="taxonomy-article">
    <h1>Arkiv</h1>
    <ul>
      <li>
