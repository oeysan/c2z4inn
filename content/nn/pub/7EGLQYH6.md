...
<article id="csl-bib-container-7EGLQYH6" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-7EGLQYH6" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-7EGLQYH6" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-7EGLQYH6" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#contributors-article-7EGLQYH6" alt="contributors" class="csl-bib-button">Medverkande</a>
    <a href="#sdg-article-7EGLQYH6" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-7EGLQYH6" class="csl-bib-meta">
  <article id="about-article-7EGLQYH6" class="about_pub-article">
    <h1>Om</h1>
    Skille og Stenling undersøkte korleis politikk blir implementert gjennom idrettslag, og peikte på eit gap i den eksisterande forskinga. Dei fann at eksisterande studiar fokuserer for mykje på dei interne prosessane i idrettslag og overser påverknaden frå lokalsamfunnet. Idrettslag er djupt forankra i sine lokale område, med deltakarar, frivillige og relasjonar til andre organisasjonar. Forfattarane argumenterer for at forståing av politikkimplementering krev å ta omsyn til desse eksterne faktorane. Dei foreslår å bruke omgrepet "konvensjon," som ser på korleis ytre oppfatningar og interaksjonar påverkar idrettslagets evne til å implementere politikk. Denne tilnærminga kan gi ei meir omfattande forståing av korleis politikk blir sett ut i livet i lokale idrettslag, og potensielt føre til meir effektive strategiar.
  </article>
  <article id="keywords-article-7EGLQYH6" class="keywords-article">
    <h1>Emneord</h1>
    Politikkimplementering, Idrettslag, Lokalsamfunn, Konvensjonar, Interorganisatoriske relasjonar
  </article>
