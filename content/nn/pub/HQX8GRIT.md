...
<article id="csl-bib-container-HQX8GRIT" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-HQX8GRIT" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-HQX8GRIT" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-HQX8GRIT" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#sdg-article-HQX8GRIT" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-HQX8GRIT" class="csl-bib-meta">
  <article id="about-article-HQX8GRIT" class="about_pub-article">
    <h1>Om</h1>
    Cohen et al. gjennomførte ein studie for å forstå kva som gjer at visse helsepersonell utmerkar seg i infeksjonskontroll og -førebygging (ICP) og korleis ein positiv avvik (PD) intervensjon påverkar deira atferd. Dei fann at profesjonelle som viser PD-atferd – dei som presterer eksepsjonelt godt – har unike sosio-kognitive eigenskapar, som sterk kjensle av ekstern kontroll, medvit om truslar og læring frå andre. Etter å ha implementert ein PD-intervensjon, rapporterte nesten 70% av dei 135 deltakarane endringar i deira atferd og etablering av støttande sosiale nettverk. Desse nettverka hjelper individ å kjenne seg ansvarlege og viktige, uavhengig av deira rolle. Studien antyder at å framheve sosiale forbindelsar på sjukehus kan forbetre infeksjonskontrollpraksisar og oppmuntre til positive atferdsendringar blant alle tilsette.
  </article>
  <article id="keywords-article-HQX8GRIT" class="keywords-article">
    <h1>Emneord</h1>
    Positiv avvik, Helsepersonell, Atferdsendring, Infeksjonskontroll, Sosio-kognitive profiler, Sosiale nettverk
  </article>
