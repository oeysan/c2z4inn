...
<article id="csl-bib-container-WKK6YXNV" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-WKK6YXNV" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-WKK6YXNV" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-WKK6YXNV" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#contributors-article-WKK6YXNV" alt="contributors" class="csl-bib-button">Medverkande</a>
    <a href="#sdg-article-WKK6YXNV" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-WKK6YXNV" class="csl-bib-meta">
  <article id="about-article-WKK6YXNV" class="about_pub-article">
    <h1>Om</h1>
    Røhnebæk og Bjerck undersøkte korleis offentlege tenester kan samskapast med sårbare brukarar, spesielt flyktningar. Dei identifiserte tre nivå der samskaping skjer: direkte interaksjonar med tenester, innan organisasjonar, og på tvers av breiare system. Dei skilte også mellom to typar samskaping: direkte deltaking, der brukarar er aktivt involverte, og representasjon, der brukarar sine behov blir fremja av andre. Ved å studere flyktningtenester utvikla dei eit rammeverk for å analysere tilhøva som mogleggjer eller hindrar samskaping. Dette rammeverket hjelper med å forstå korleis ein betre kan involvere sårbare grupper i utforminga av tenestene dei mottar, noko som kan føre til meir effektive og responsive offentlege tenester. Funna deira er viktige for å forbetre korleis offentlege tenester engasjerer seg med og støttar sårbare befolkningar.
  </article>
  <article id="keywords-article-WKK6YXNV" class="keywords-article">
    <h1>Emneord</h1>
    Samskaping, Sårbare brukarar, Flyktningtenester, Offentlege tenester, Tenesteinteraksjonar
  </article>
  ...
  <article id="taxonomy-article-WKK6YXNV" class="taxonomy-article">
    ...
    <ul>
      ...
      <li>
        <a href="/nn/archive/?key=6ZJVHCGB">April</a>
      </li>
    </ul>
    <ul>
      <li>
      ...
      <li>
        <a href="/nn/archive/?key=HTK8K4LC">April</a>
      </li>
    </ul>
  </article>
</div>
