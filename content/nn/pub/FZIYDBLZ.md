...
<article id="csl-bib-container-FZIYDBLZ" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-FZIYDBLZ" alt="archive" class="csl-bib-button">Arkiv</a>
    ...
    <a href="#keywords-article-FZIYDBLZ" alt="keywords" class="csl-bib-button">Emneord</a>
    <a href="#about-article-FZIYDBLZ" alt="about_pub" class="csl-bib-button">Om</a>
    <a href="#contributors-article-FZIYDBLZ" alt="contributors" class="csl-bib-button">Medverkande</a>
    <a href="#sdg-article-FZIYDBLZ" alt="sdg" class="csl-bib-button">Berekraftsmål</a>
...
<div id="csl-bib-meta-FZIYDBLZ" class="csl-bib-meta">
  <article id="about-article-FZIYDBLZ" class="about_pub-article">
    <h1>Om</h1>
    Angelstam et al. studerte påverknaden av skogutnytting og verneområde på habitatnettverk i 16 regionar på fem kontinent. Dei fann at vernetiltak varierte mykje, og dekka mellom 3 % og 77 % av områda. Effektiviteten av desse verna habitat avhang av faktorar som habitatkvalitet, konnektivitet og tilstedeværet av "papirparkar" (område verna berre på papiret). Dei merka også at reguleringspolitikkar var vanlegare enn økonomiske eller informasjonsbaserte. Dessverre var negative effektar frå omkringliggande område ofte større enn positive, bortsett frå i regionar som tidlegare Sovjetunionen og Costa Rica. Trass i kunnskap om kva som må gjerast for vern, var den generelle trenden for vern av biologisk mangfald negativ, noko som understrekar utfordringane med å balansere skogbruk og naturvern.
  </article>
  <article id="keywords-article-FZIYDBLZ" class="keywords-article">
    <h1>Emneord</h1>
    Verneområde, Skogutnytting, Habitatnettverk, Verneinstrument, Politikkimplementering
  </article>
