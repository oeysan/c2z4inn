...
---
<h1>Publication</h1>
<article id="csl-bib-container-MFQQWUED" class="csl-bib-container">
  <div class="csl-bib-body" style="line-height: 1.35; padding-left: 1em; text-indent:-1em;">
  <div class="csl-entry">Broch, T. B. (2019). <i>A performative feel for the game: how meaningful sports shape gender, bodies, and social life</i>. Palgrave Macmillan.</div>
</div>
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-MFQQWUED" class="csl-bib-button">Archive</a>
    <a href="https://app.cristin.no/results/show.jsf?id=1774839" alt="Cristin URL" class="csl-bib-button">Cristin</a>
    <a href="http://zotero.org/groups/5402882/items/MFQQWUED" alt="Zotero URL" class="csl-bib-button">Zotero</a>
    <a href="#abstract-article-MFQQWUED" class="csl-bib-button">Abstract</a>
    <a href="#contributors-article-MFQQWUED" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-MFQQWUED" class="csl-bib-button">Sustainable Development Goals</a>
  </div>
  <div id="csl-bib-meta-container-MFQQWUED"></div>
</article>
<div id="csl-bib-meta-MFQQWUED" class="csl-bib-meta">
  <article id="abstract-article-MFQQWUED" class="abstract-article">
    <h1>Abstract</h1>
  ...
  <article id="contributors-article-MFQQWUED" class="contributors-article">
    <h1>Contributors</h1>
  ...
  <article id="sdg-article-MFQQWUED" class="sdg-article">
  ...
  <article id="taxonomy-article-MFQQWUED" class="taxonomy-article">
    <h1>Archive</h1>
    <ul>
