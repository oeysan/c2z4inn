...
<article id="csl-bib-container-JXXNCBQV" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-JXXNCBQV" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-JXXNCBQV" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-JXXNCBQV" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#sdg-article-JXXNCBQV" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
  </div>
...
<div id="csl-bib-meta-JXXNCBQV" class="csl-bib-meta">
  <article id="about-article-JXXNCBQV" class="about_pub-article">
    <h1>About</h1>
    Dickman et al. discuss the complex issue of human-wildlife conflicts, where animals pose threats to people's safety and livelihoods, leading to disputes over how to handle these situations. These conflicts can undermine community support for conservation efforts, especially when negative interactions with wildlife are frequent. The authors highlight that each conflict is unique, making it difficult to apply one-size-fits-all solutions. They emphasize that these conflicts are not just about humans versus animals but also involve social disagreements among people. The study covers various species, from large predators like bears and elephants to smaller animals and plants, noting that iconic species often receive more attention despite other animals causing more harm. Understanding and addressing these conflicts is crucial for both human safety and wildlife conservation.
  </article>
  <article id="keywords-article-JXXNCBQV" class="keywords-article">
    <h1>Keywords</h1>
    Human-Wildlife Conflict, Conservation, Wildlife Management, Social Conflict, Economic Incentives
  </article>
