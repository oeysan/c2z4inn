...
<article id="csl-bib-container-HHKJY8HE" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-HHKJY8HE" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-HHKJY8HE" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-HHKJY8HE" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-HHKJY8HE" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-HHKJY8HE" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-HHKJY8HE" class="csl-bib-meta">
  <article id="about-article-HHKJY8HE" class="about_pub-article">
    <h1>About</h1>
    Mathisen et al. studied how moose (large deer-like animals) interact with trees in Norwegian boreal forests. They found that when moose repeatedly eat from certain trees, those trees grow back quickly, making them even more attractive to moose. This means that trees that have been browsed before are more likely to be browsed again. The study showed that this pattern happens across different types of trees, including both conifers (like pine trees) and deciduous trees (like birch). This continuous browsing can lead to higher tree mortality, especially in areas with many moose. These findings are important for understanding how moose affect forest health and can help inform better forestry practices to manage tree populations.
  </article>
  <article id="keywords-article-HHKJY8HE" class="keywords-article">
    <h1>Keywords</h1>
    Moose Browsing, Tree Morphology, Herbivory, Boreal Forests, Plant Strategies
  </article>
...
Our results suggest that the adaptation for rapid regrowth after browsing does not reduce herbivory on trees. Rather, our results indicate that plant responses to browsing increase the probability of future herbivory. This response could potentially lead to higher plant mortality where cervid populations are maintained at stable high densities and has implications for plant population dynamics and forestry practices.
  ...
  <article id="taxonomy-article-HHKJY8HE" class="taxonomy-article">
    ...
    <ul>
      ...
      <li><a href="{{< params subfolder >}}en/archive/?key=DCVJIFZY">April</a></li>
    </ul>
  </article>
</div>
