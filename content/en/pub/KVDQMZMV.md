...
<article id="csl-bib-container-KVDQMZMV" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-KVDQMZMV" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-KVDQMZMV" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-KVDQMZMV" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-KVDQMZMV" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-KVDQMZMV" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-KVDQMZMV" class="csl-bib-meta">
  <article id="about-article-KVDQMZMV" class="about_pub-article">
    <h1>About</h1>
    Angelstam et al. reviewed Swedish policies aimed at conserving forest biodiversity and found that while the policies are based on solid evidence, they are not achieving the desired results. They examined the implementation of these policies, including setting goals for protected areas and educating stakeholders, but noted that the amount of protected forest is too low and lacks quality and connectivity. The study highlights challenges such as insufficient collaboration among planners, inadequate funding, and political disregard for scientific evidence. To improve forest conservation, the authors suggest diversifying forest management practices and adopting a landscape perspective that aligns with the goals of forest owners and regional contexts. This approach requires better integration of knowledge, learning, and planning.
  </article>
  <article id="keywords-article-KVDQMZMV" class="keywords-article">
    <h1>Keywords</h1>
    Forest Biodiversity, Conservation, Green Infrastructure, Policy Implementation, Habitat Restoration, Sweden
  </article>
