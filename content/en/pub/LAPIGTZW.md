...
---
<h1>Publication</h1>
<article id="csl-bib-container-LAPIGTZW" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-LAPIGTZW" class="csl-bib-button">Archive</a>
    <a href="https://app.cristin.no/results/show.jsf?id=1727056" alt="Cristin URL" class="csl-bib-button">Cristin</a>
    <a href="http://zotero.org/groups/5402882/items/LAPIGTZW" alt="Zotero URL" class="csl-bib-button">Zotero</a>
    <a href="#abstract-article-LAPIGTZW" class="csl-bib-button">Abstract</a>
    <a href="#contributors-article-LAPIGTZW" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-LAPIGTZW" class="csl-bib-button">Sustainable Development Goals</a>
  ...
  <div id="csl-bib-meta-container-LAPIGTZW"></div>
</article>
<div id="csl-bib-meta-LAPIGTZW" class="csl-bib-meta">
  <article id="abstract-article-LAPIGTZW" class="abstract-article">
    <h1>Abstract</h1>
  ...
  <article id="contributors-article-LAPIGTZW" class="contributors-article">
    <h1>Contributors</h1>
  ...
  <article id="sdg-article-LAPIGTZW" class="sdg-article">
    <h1>Sustainable Development Goals</h1>
    <div class="sdg-container"><div id="sdg3" class="sdg"> <img src="{{< params subfolder >}}images/sdg/sdg03_en.png" class="image" alt="SDG 3"> <div class="sdg-overlay"> <a href="{{< params subfolder >}}en/archive/?sdg=3#archive" class="sdg-publication-count"><span>6</span> Publications</a> <p><a href="https://sdgs.un.org/goals/goal3" class="sdg-read-more">Read More</a></p> </div> </div></div>
  </article>
  <article id="taxonomy-article-LAPIGTZW" class="taxonomy-article">
    <h1>Archive</h1>
    <ul>
