...
<article id="csl-bib-container-4I7AZX6H" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-4I7AZX6H" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-4I7AZX6H" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-4I7AZX6H" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-4I7AZX6H" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-4I7AZX6H" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-4I7AZX6H" class="csl-bib-meta">
  <article id="about-article-4I7AZX6H" class="about_pub-article">
    <h1>About</h1>
    Viluma et al. studied the genetic changes in a small, highly inbred population of Scandinavian wolves over 30 years. They analyzed the whole-genome sequences of 76 wolves descended from just three founders. Their research found that 10%–24% of the genetic material from the original wolves was lost due to inbreeding. This loss included 160,000 specific genetic variations, which could affect the wolves' ability to adapt and survive. The study highlights how genetic drift, a process where allele frequencies change randomly, can significantly reduce genetic diversity in small populations. This research is important for understanding the genetic health of endangered species and can inform conservation strategies to prevent further loss of genetic diversity.
  </article>
  <article id="keywords-article-4I7AZX6H" class="keywords-article">
    <h1>Keywords</h1>
    Genetic Drift, Inbreeding, Haplotype Diversity, Scandinavian Wolf Population, Genome-Wide Analysis
  </article>
