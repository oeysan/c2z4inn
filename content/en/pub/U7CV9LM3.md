...
<article id="csl-bib-container-U7CV9LM3" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-U7CV9LM3" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-U7CV9LM3" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-U7CV9LM3" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-U7CV9LM3" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-U7CV9LM3" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-U7CV9LM3" class="csl-bib-meta">
  <article id="about-article-U7CV9LM3" class="about_pub-article">
    <h1>About</h1>
    Macintyre et al. conducted a study to understand how extreme sport athletes interact with nature and how these interactions affect their well-being and environmental behaviors. They interviewed eight athletes, exploring their childhood experiences, emotional responses to nature, and how nature helps them cope and recover psychologically. The study found that these athletes share common attitudes towards nature, feeling emotionally connected and concerned about the environment. Participating in extreme sports not only boosts their mental health and resilience but also fosters a strong bond with nature, encouraging pro-environmental behavior. This research highlights the positive psychological and environmental impacts of extreme sports, challenging the stereotype that these athletes are disconnected from nature.
  </article>
  <article id="keywords-article-U7CV9LM3" class="keywords-article">
    <h1>Keywords</h1>
    Extreme Sport Athletes, Nature Interactions, Well-being, Resilience, Pro-Environmental Behavior, Emotional Response
  </article>
  ...
  <article id="taxonomy-article-U7CV9LM3" class="taxonomy-article">
    ...
    <ul>
      ...
      <li><a href="{{< params subfolder >}}en/archive/?key=65UR52MG">May</a></li>
    </ul>
  </article>
</div>
