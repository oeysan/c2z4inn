...
<article id="csl-bib-container-BINP7ILL" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-BINP7ILL" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-BINP7ILL" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-BINP7ILL" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#sdg-article-BINP7ILL" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-BINP7ILL" class="csl-bib-meta">
  <article id="about-article-BINP7ILL" class="about_pub-article">
    <h1>About</h1>
    Braaten et al. conducted a study examining mercury levels in freshwater fish across boreal and subarctic regions of Fennoscandia over 50 years. They found that mercury levels in fish like pike and perch have significantly decreased, especially after 2000, indicating improved environmental conditions. Initially, 74% of lakes had mercury levels above the safe limit for human health, but this dropped to 25% after 2000. The decline is attributed to pollution control measures and reduced long-range air pollution. This matters because lower mercury levels make fish safer to eat and reflect healthier ecosystems. The authors suggest future monitoring should include detailed data collection to better assess the impact of pollution reduction efforts. This study highlights the positive effects of environmental policies on public health and ecosystems.
  </article>
  <article id="keywords-article-BINP7ILL" class="keywords-article">
    <h1>Keywords</h1>
    Mercury Levels, Freshwater Fish, Boreal, Subarctic, Fennoscandia, Environmental Status
  </article>
