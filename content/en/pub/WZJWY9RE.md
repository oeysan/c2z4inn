...
<article id="csl-bib-container-WZJWY9RE" class="csl-bib-container">
  <div class="csl-bib-body"> <div class="csl-entry">Forfang, H., &#38; Paulsen, J. M. (2024). Hva betyr kvalitetsarbeid i skolen? In J. M. Paulsen &#38; H. Forfang (Eds.), <i>Ledelse av kvalitetsarbeid i skolen</i> (pp. 15–36). Fagbokforlaget.</div> </div>
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-WZJWY9RE" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-WZJWY9RE" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-WZJWY9RE" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-WZJWY9RE" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-WZJWY9RE" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
  </div>
...
<div id="csl-bib-meta-WZJWY9RE" class="csl-bib-meta">
  <article id="about-article-WZJWY9RE" class="about_pub-article">
    <h1>About</h1>
    Forfang and Paulsen explore how schools in Norway can improve their quality through collective learning processes. Their book builds on previous research, emphasizing that quality development in schools is a continuous effort involving teachers, school leaders, and other staff. This process includes setting goals, choosing actions, and evaluating progress, followed by adjustments and new objectives. The authors highlight the importance of using various data sources to assess school quality, focusing on three dimensions: structure (how schools are organized), process (how teaching is conducted), and results (student outcomes). Understanding these dimensions helps schools systematically enhance their educational practices, ultimately benefiting students' futures. This approach is crucial for ensuring consistent and effective education across different regions and schools.
  </article>
