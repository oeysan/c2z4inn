...
<article id="csl-bib-container-L9F3ELBM" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-L9F3ELBM" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-L9F3ELBM" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-L9F3ELBM" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-L9F3ELBM" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-L9F3ELBM" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
  </div>
...
<div id="csl-bib-meta-L9F3ELBM" class="csl-bib-meta">
  <article id="about-article-L9F3ELBM" class="about_pub-article">
    <h1>About</h1>
    Valsdottir et al. conducted a study to explore how different diets and exercise affect weight loss and fat distribution in overweight or obese women. Over 10 weeks, 57 participants followed either a low-carbohydrate high-fat diet or a normal diet, with some also doing aerobic exercise. All groups lost weight, but the low-carbohydrate high-fat diet led to less fat around the abdomen compared to the normal diet. However, this diet did not improve glucose tolerance, which is how well the body processes sugar. This research is important because it suggests that while certain diets can change where fat is stored, they might not necessarily improve how the body handles sugar, which is crucial for preventing diabetes.
  </article>
  <article id="keywords-article-L9F3ELBM" class="keywords-article">
    <h1>Keywords</h1>
    Aerobic Exercise, Low-Carbohydrate High-Fat Diet, Glucose Tolerance, Android Fat, Gynoid Fat, Overweight
  </article>
