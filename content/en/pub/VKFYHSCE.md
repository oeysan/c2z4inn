...
<article id="csl-bib-container-VKFYHSCE" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-VKFYHSCE" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-VKFYHSCE" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-VKFYHSCE" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-VKFYHSCE" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-VKFYHSCE" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-VKFYHSCE" class="csl-bib-meta">
  <article id="about-article-VKFYHSCE" class="about_pub-article">
    <h1>About</h1>
    Mavrantza et al. conducted a study to explore how walking in nature (green exercise) and walking with virtual nature scenes (virtual green exercise) affect mental health compared to indoor walking. They found that walking in nature led to the most significant improvements in mood and stress reduction, with noticeable changes in brain activity. Virtual nature also improved mood and helped focus attention, but not as strongly as real nature. The study involved 30 participants who walked at their own pace while their heart rate and brain activity were monitored. These findings suggest that spending time in nature, even virtually, can enhance mental well-being by altering brain activity, particularly in areas related to attention and emotional processing.
  </article>
  <article id="keywords-article-VKFYHSCE" class="keywords-article">
    <h1>Keywords</h1>
    Green Exercise, Virtual Green Exercise, Psychological States, Heart Rate Variability, Brain Activity, Self-Paced Walking
  </article>
