...
<article id="csl-bib-container-H9R4HE2X" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-H9R4HE2X" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-H9R4HE2X" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-H9R4HE2X" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#sdg-article-H9R4HE2X" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-H9R4HE2X" class="csl-bib-meta">
  <article id="about-article-H9R4HE2X" class="about_pub-article">
    <h1>About</h1>
    Backman et al. explore how physical education teacher education (PETE) impacts teaching practices in schools. They focus on the transition from PETE courses to actual school physical education, a topic that hasn't been extensively studied. The authors propose a new method to investigate this transition, using interviews, observations, and social media interactions with teachers and students. They specifically look at how the concept of "Assessment for Learning" is applied in schools after being taught in PETE. Their findings suggest that understanding these transitions can help improve PETE programs and support ongoing professional development for teachers. This research is important because it aims to bridge the gap between teacher education and practical teaching, ultimately enhancing the quality of physical education in schools.
  </article>
  <article id="keywords-article-H9R4HE2X" class="keywords-article">
    <h1>Keywords</h1>
    Physical Education Teacher Education, School Physical Education, Assessment for Learning, Teacher Education, Teaching Practice
  </article>
