...
<article id="csl-bib-container-ABDXKY5U" class="csl-bib-container">
  <div class="csl-bib-body"> <div class="csl-entry">Rørvik, S. (2022). Word Order in Additional Language English Spoken by Multilinguals. In M. Monsen &#38; G. B. Steien (Eds.), <i>Language learning and forced migration</i> (pp. 123–138). Multilingual Matters.</div> </div>
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-ABDXKY5U" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-ABDXKY5U" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-ABDXKY5U" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-ABDXKY5U" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-ABDXKY5U" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
  </div>
...
<div id="csl-bib-meta-ABDXKY5U" class="csl-bib-meta">
  <article id="about-article-ABDXKY5U" class="about_pub-article">
    <h1>About</h1>
    Rørvik conducted a study on how refugees in Norway learn and use English as an additional language. They explored various aspects of language learning, including the structure of sentences, cognitive processes, social interactions, and critical perspectives. By examining data from the same group of individuals, the study provides a comprehensive understanding of how multilingual refugees adapt to using English in their daily lives. This research is important because it highlights the challenges and strategies involved in language acquisition for people who have been displaced, offering valuable insights for educators and policymakers to support effective language learning and integration.
  </article>
  <article id="keywords-article-ABDXKY5U" class="keywords-article">
    <h1>Keywords</h1>
    Language Learning, Multilingualism, Refugees, Norway, Migration
  </article>
  ...
  <article id="taxonomy-article-ABDXKY5U" class="taxonomy-article">
    ...
    <ul>
      ...
      <li><a href="{{< params subfolder >}}en/archive/?key=U4E9RIHB">October</a></li>
    </ul>
  </article>
</div>
