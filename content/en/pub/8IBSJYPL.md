...
---
<h1>Publication</h1>
<article id="csl-bib-container-8IBSJYPL" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-8IBSJYPL" class="csl-bib-button">Archive</a>
    <a href="https://app.cristin.no/results/show.jsf?id=1992769" alt="Cristin URL" class="csl-bib-button">Cristin</a>
    <a href="http://zotero.org/groups/5402882/items/8IBSJYPL" alt="Zotero URL" class="csl-bib-button">Zotero</a>
    <a href="#abstract-article-8IBSJYPL" class="csl-bib-button">Abstract</a>
    <a href="#contributors-article-8IBSJYPL" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-8IBSJYPL" class="csl-bib-button">Sustainable Development Goals</a>
  </div>
  <div id="csl-bib-meta-container-8IBSJYPL"></div>
</article>
<div id="csl-bib-meta-8IBSJYPL" class="csl-bib-meta">
  <article id="abstract-article-8IBSJYPL" class="abstract-article">
    <h1>Abstract</h1>
  ...
  <article id="contributors-article-8IBSJYPL" class="contributors-article">
    <h1>Contributors</h1>
  ...
  <article id="sdg-article-8IBSJYPL" class="sdg-article">
    <h1>Sustainable Development Goals</h1>
    <div class="sdg-container"><div id="sdg3" class="sdg"> <img src="{{< params subfolder >}}images/sdg/sdg03_en.png" class="image" alt="SDG 3"> <div class="sdg-overlay"> <a href="{{< params subfolder >}}en/archive/?sdg=3#archive" class="sdg-publication-count"><span>5</span> Publications</a> <p><a href="https://sdgs.un.org/goals/goal3" class="sdg-read-more">Read More</a></p> </div> </div></div>
  </article>
  <article id="taxonomy-article-8IBSJYPL" class="taxonomy-article">
    <h1>Archive</h1>
    <ul>
