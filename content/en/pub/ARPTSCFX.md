...
<article id="csl-bib-container-ARPTSCFX" class="csl-bib-container">
  <div class="csl-bib-body"> <div class="csl-entry">Ede, A., Kleppe, S. L., &#38; Sorby, A. (Eds.). (2023). <i>Poetry and the Global Climate Crisis: Creative Educational Approaches to Complex Challenges</i>. Routledge. <a href="https://www.routledge.com/Poetry-and-the-Global-Climate-Crisis-Creative-Educational-Approaches-to/Ede-Kleppe-Sorby/p/book/9781032508542?_ga=1300589989.1690416000&#38;gclid=CjwKCAiA-P-rBhBEEiwAQEXhH32EG4nw">https://www.routledge.com/Poetry-and-the-Global-Climate-Crisis-Creative-Educational-Approaches-to/Ede-Kleppe-Sorby/p/book/9781032508542?_ga=1300589989.1690416000&#38;gclid=CjwKCAiA-P-rBhBEEiwAQEXhH32EG4nw</a></div> </div>
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-ARPTSCFX" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-ARPTSCFX" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-ARPTSCFX" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#sdg-article-ARPTSCFX" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
  </div>
...
<div id="csl-bib-meta-ARPTSCFX" class="csl-bib-meta">
  <article id="about-article-ARPTSCFX" class="about_pub-article">
    <h1>About</h1>
    Ede et al. explore how poetry can help people understand and address environmental issues in their book. They show that writing, reading, and teaching poetry can make individuals more aware of and responsive to climate change. The book includes essays that offer practical and theoretical insights, making it useful for educators. It covers diverse global perspectives, including Indigenous responses to climate change, climate migration, and the impact of colonialism, racism, and sexism on the environment. By integrating poetry into discussions about these topics, the authors provide creative tools and approaches for teaching about sustainability and development. This book is particularly valuable for educators in the humanities who want to inspire empathy and empowerment in their students.
  </article>
  <article id="keywords-article-ARPTSCFX" class="keywords-article">
    <h1>Keywords</h1>
    Poetry, Climate Crisis, Environmental Education, Creative Approaches, Indigenous Responses, Climate Migration
  </article>
  ...
  <article id="taxonomy-article-ARPTSCFX" class="taxonomy-article">
    ...
    <ul>
      ...
      <li><a href="{{< params subfolder >}}en/archive/?key=UKR47W3H">October</a></li>
    </ul>
  </article>
</div>
