...
<article id="csl-bib-container-VJI3W5RT" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-VJI3W5RT" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-VJI3W5RT" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-VJI3W5RT" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-VJI3W5RT" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-VJI3W5RT" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-VJI3W5RT" class="csl-bib-meta">
  <article id="about-article-VJI3W5RT" class="about_pub-article">
    <h1>About</h1>
    Mehnen et al. conducted a study on rural and touristic challenges in the German Wadden Sea Region, focusing on four municipalities—two island and two mainland. They found that island municipalities faced more tourism-related issues compared to mainland ones. Key challenges included maintaining public services, ensuring community welfare, and conserving natural environments. The authors emphasized the importance of involving local communities in decision-making (participatory governance) to address these issues effectively. They also highlighted the need for coordinated efforts at both local and regional levels to tackle these challenges comprehensively. By combining local insights with broader regional planning, communities can better manage rural development and tourism impacts, leading to more sustainable and resilient landscapes.
  </article>
  <article id="keywords-article-VJI3W5RT" class="keywords-article">
    <h1>Keywords</h1>
    Rural Landscapes, Nature-Based Tourism, Participatory Governance, Peripheral Municipalities, Coping Strategies, German Wadden Sea Region
  </article>
