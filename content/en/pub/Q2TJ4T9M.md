...
<article id="csl-bib-container-Q2TJ4T9M" class="csl-bib-container">
  <div class="csl-bib-body"> <div class="csl-entry">Pooley, S., Hill, C., &#38; Linnell, J. D. (2023). How histories shape interactions. In A. Zimmermann, C. Inskip, &#38; J. Stevens (Eds.), <i>IUCN SSC guidelines on human-wildlife conflict and coexistence</i> (pp. 68–73). International Union for Conservation of Nature (IUCN). <a href="https://portals.iucn.org/library/sites/library/files/documents/2023-009-En.pdf">https://portals.iucn.org/library/sites/library/files/documents/2023-009-En.pdf</a></div> </div>
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-Q2TJ4T9M" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-Q2TJ4T9M" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-Q2TJ4T9M" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#sdg-article-Q2TJ4T9M" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
  </div>
...
<div id="csl-bib-meta-Q2TJ4T9M" class="csl-bib-meta">
  <article id="about-article-Q2TJ4T9M" class="about_pub-article">
    <h1>About</h1>
    Pooley et al. explore how conflicts between humans and wildlife can threaten people's safety and livelihoods, leading to disputes over how to handle these situations. These conflicts can undermine community support for conservation efforts, especially when negative interactions with wildlife are frequent. The authors highlight that each conflict is unique, influenced by its specific history and circumstances, making it difficult to apply one-size-fits-all solutions. They emphasize that human-wildlife conflicts are often rooted in social disagreements among people. The study notes that while many species can be involved, iconic or threatened animals like elephants and large cats tend to receive more attention and media coverage, even if other species, like venomous snakes, pose greater risks. This research underscores the need for tailored, sustainable approaches to managing these conflicts.
  </article>
