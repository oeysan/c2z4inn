...
<article id="csl-bib-container-D85ZVJGZ" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-D85ZVJGZ" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-D85ZVJGZ" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-D85ZVJGZ" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-D85ZVJGZ" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-D85ZVJGZ" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-D85ZVJGZ" class="csl-bib-meta">
  <article id="about-article-D85ZVJGZ" class="about_pub-article">
    <h1>About</h1>
    Litleskare et al. reviewed how virtual nature—simulated natural environments using technology—can positively impact health and well-being. They noted that being in nature helps reduce stress and improve mood, but modern life, especially urbanization and increased screen time, is distancing people from real nature. The authors suggest that virtual nature could be a beneficial addition to real nature, helping people reconnect with the natural world and enhancing human-nature interactions. They propose guidelines for future research to explore these benefits further. This review is important because it highlights how technology might help bridge the gap between people and nature, potentially improving overall well-being in an increasingly digital world.
  </article>
  <article id="keywords-article-D85ZVJGZ" class="keywords-article">
    <h1>Keywords</h1>
    Virtual Nature, Health and Well-being, Technology, Nature Exposure, Stress Reduction
  </article>
  ...
  <article id="taxonomy-article-D85ZVJGZ" class="taxonomy-article">
    ...
    <ul>
      ...
      <li><a href="{{< params subfolder >}}en/archive/?key=XWGN6MDY">March</a></li>
    </ul>
  </article>
</div>
