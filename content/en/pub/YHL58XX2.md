...
<article id="csl-bib-container-YHL58XX2" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-YHL58XX2" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-YHL58XX2" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-YHL58XX2" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-YHL58XX2" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-YHL58XX2" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-YHL58XX2" class="csl-bib-meta">
  <article id="about-article-YHL58XX2" class="about_pub-article">
    <h1>About</h1>
    Berglund et al. conducted a study to understand how parents' drinking habits, their monitoring of their children, and the children's own behaviors affect the likelihood of teenagers drinking alcohol and getting drunk. They found that if parents drink alcohol, their teenagers are more likely to do the same, especially at age 17. Teens who seek new and exciting experiences are at higher risk of drinking at all ages studied. Interestingly, parents' efforts to control or know their children's activities didn't make a difference. However, when parents actively asked about their teens' lives, it increased the chances of drinking at age 17, while teens who voluntarily shared information with their parents were less likely to drink. This study suggests parents should be mindful of their own drinking and pay attention to teens who crave excitement.
  </article>
  <article id="keywords-article-YHL58XX2" class="keywords-article">
    <h1>Keywords</h1>
    Alcohol Consumption, Parental Monitoring, Adolescent Disclosure, Novelty-Seeking Behaviour, Adolescent Alcohol Use, Innebriation
  </article>
  ...
  <article id="taxonomy-article-YHL58XX2" class="taxonomy-article">
    ...
    <ul>
      ...
      <li><a href="{{< params subfolder >}}en/archive/?key=PB42H2MG">December</a></li>
    </ul>
  </article>
</div>
