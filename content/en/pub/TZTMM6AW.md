...
<article id="csl-bib-container-TZTMM6AW" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-TZTMM6AW" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-TZTMM6AW" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-TZTMM6AW" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#sdg-article-TZTMM6AW" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-TZTMM6AW" class="csl-bib-meta">
  <article id="about-article-TZTMM6AW" class="about_pub-article">
    <h1>About</h1>
    Hestad et al. conducted an 8-year study to explore how blood pressure (BP) affects cognitive performance in adults aged 45-74 years. They found that higher BP at a younger age (45-55 years) was linked to poorer cognitive function in men, but this trend reversed for men over 65, where higher BP was associated with better cognition. For women, the relationship was less clear and sometimes opposite; higher BP at younger ages was linked to better cognition, but at older ages, it was associated with poorer cognition. These findings suggest that age and sex significantly influence how BP impacts cognitive abilities, highlighting the importance of personalized health monitoring as people age.
  </article>
  <article id="keywords-article-TZTMM6AW" class="keywords-article">
    <h1>Keywords</h1>
    Blood Pressure, Cognitive Performance, Aging, Sex Differences, Longitudinal Study
  </article>
...
Conclusion: Increased SBP and DBP at the younger age was clearly associated with poorer cognitive function in men 8 years later; in women the associations were weaker and sometimes in the opposite direction. Our findings clearly indicate that interactions between age and sex related to BP can predict cognitive performance over time. Men and women have different age trajectories regarding the influence of BP on cognition.
  ...
  <article id="taxonomy-article-TZTMM6AW" class="taxonomy-article">
    ...
    <ul>
      ...
      <li><a href="{{< params subfolder >}}en/archive/?key=TMCTTML2">May</a></li>
    </ul>
  </article>
</div>
