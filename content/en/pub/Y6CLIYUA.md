...
---
<h1>Publication</h1>
<article id="csl-bib-container-Y6CLIYUA" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-Y6CLIYUA" class="csl-bib-button">Archive</a>
    <a href="https://app.cristin.no/results/show.jsf?id=1514849" alt="Cristin URL" class="csl-bib-button">Cristin</a>
    <a href="http://zotero.org/groups/5402882/items/Y6CLIYUA" alt="Zotero URL" class="csl-bib-button">Zotero</a>
    <a href="#abstract-article-Y6CLIYUA" class="csl-bib-button">Abstract</a>
    <a href="#sdg-article-Y6CLIYUA" class="csl-bib-button">Sustainable Development Goals</a>
    <a href="https://journals.sagepub.com/doi/pdf/10.1177/1403494817743903" class="csl-bib-button">Unpaywall</a>
  </div>
  <div id="csl-bib-meta-container-Y6CLIYUA"></div>
</article>
<div id="csl-bib-meta-Y6CLIYUA" class="csl-bib-meta">
  <article id="abstract-article-Y6CLIYUA" class="abstract-article">
    <h1>Abstract</h1>
  ...
  <article id="sdg-article-Y6CLIYUA" class="sdg-article">
    <h1>Sustainable Development Goals</h1>
    <div class="sdg-container"><div id="sdg3" class="sdg"> <img src="{{< params subfolder >}}images/sdg/sdg03_en.png" class="image" alt="SDG 3"> <div class="sdg-overlay"> <a href="{{< params subfolder >}}en/archive/?sdg=3#archive" class="sdg-publication-count"><span>6</span> Publications</a> <p><a href="https://sdgs.un.org/goals/goal3" class="sdg-read-more">Read More</a></p> </div> </div></div>
  </article>
  <article id="taxonomy-article-Y6CLIYUA" class="taxonomy-article">
    <h1>Archive</h1>
    <ul>
