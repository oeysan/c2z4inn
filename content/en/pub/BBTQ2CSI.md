...
---
<h1>Publication</h1>
<article id="csl-bib-container-BBTQ2CSI" class="csl-bib-container">
  <div class="csl-bib-body"> <div class="csl-entry">Skille, E. Å., &#38; Pettersen, S. (2016). <i>Den moderne telemarksbølgen</i>. Oplandske Bokforlag. <a href="http://www.oplandskebokforlag.no/index.php?do=product&#38;id=225">http://www.oplandskebokforlag.no/index.php?do=product&#38;id=225</a></div> </div>
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-BBTQ2CSI" alt="archive" class="csl-bib-button">Archive</a>
    <a href="https://app.cristin.no/results/show.jsf?id=1431822" alt="Cristin" class="csl-bib-button">Cristin</a>
    <a href="http://zotero.org/groups/5881554/items/BBTQ2CSI" alt="Zotero" class="csl-bib-button">Zotero</a>
    <a href="#keywords-article-BBTQ2CSI" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-BBTQ2CSI" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-BBTQ2CSI" alt="contributors" class="csl-bib-button">Contributors</a>
  </div>
  <div id="csl-bib-meta-container-BBTQ2CSI"></div>
</article>
<div id="csl-bib-meta-BBTQ2CSI" class="csl-bib-meta">
  <article id="about-article-BBTQ2CSI" class="about_pub-article">
    <h1>About</h1>
    Skille and Pettersen explore the rise and fall of telemark skiing in Norway during the 1980s and 1990s in their book. They trace its origins as a social phenomenon in America in the 1970s and its subsequent popularity in Norwegian ski resorts. The authors examine personal stories and organizational influences, as well as telemark's portrayal in media and its status as an exclusive sport for affluent individuals. Using interviews, document analysis, and statistical methods, they compare telemark skiing to other sports like golf and snowboarding, applying theories of cultural diffusion and social fields. This study is aimed at researchers, sports students, and anyone interested in the unique role of telemark skiing in Norwegian ski history.
  </article>
  <article id="keywords-article-BBTQ2CSI" class="keywords-article">
    <h1>Keywords</h1>
    Telemark Skiing, Social Phenomenon, Norway, Ski History, Sports Sociology, Media Analysis
  </article>
  <article id="abstract-article-BBTQ2CSI" class="abstract-article">
...
Den moderne telemarksbølgen er skrevet for forskere, idrettsstudenter med samfunnsfaglig interesse og for andre som vil vite mer om telemarks spesielle rolle i norsk skihistorie
  ...
  <article id="contributors-article-BBTQ2CSI" class="contributors-article">
    <h1>Contributors</h1>
