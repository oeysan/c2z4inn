...
<article id="csl-bib-container-FW74Z5DP" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-FW74Z5DP" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-FW74Z5DP" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-FW74Z5DP" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-FW74Z5DP" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-FW74Z5DP" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-FW74Z5DP" class="csl-bib-meta">
  <article id="about-article-FW74Z5DP" class="about_pub-article">
    <h1>About</h1>
    Backéus et al. conducted a 20-year study on tree growth in miombo and acacia woodlands in Tanzania, focusing on a degraded area undergoing restoration. They examined 15 tree species to understand how their diameter growth compared to previous studies. The researchers found that growth rates varied among species and increased with stem diameter in several cases. Notably, tree growth was significantly higher during the rainy year of 1997/98, suggesting that soil water availability is crucial for growth. This study highlights that allowing natural tree development might be a viable alternative to planting trees on less fertile land, emphasizing the importance of water in supporting tree growth in restoration efforts.
  </article>
  <article id="keywords-article-FW74Z5DP" class="keywords-article">
    <h1>Keywords</h1>
    Diameter Growth, Miombo Woodland, Acacia Woodland, Landscape Restoration, Tree Growth, Soil Water
  </article>
