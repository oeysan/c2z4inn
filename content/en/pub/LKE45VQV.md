...
<article id="csl-bib-container-LKE45VQV" class="csl-bib-container">
  ...
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-LKE45VQV" alt="archive" class="csl-bib-button">Archive</a>
    ...
    <a href="#keywords-article-LKE45VQV" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-LKE45VQV" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-LKE45VQV" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-LKE45VQV" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
...
<div id="csl-bib-meta-LKE45VQV" class="csl-bib-meta">
  <article id="about-article-LKE45VQV" class="about_pub-article">
    <h1>About</h1>
    Giergiczny et al. conducted a study on the attitudes of ecotourism business owners in Poland and Belarus toward the conservation of the Białowieża Forest, a shared forest area between the two countries. They found that Belarusian business owners generally supported increased protection of the forest, while Polish business owners were less supportive. Factors influencing these attitudes included the proportion of foreign guests, local origin, business size, and the role of foresters as customers. The study suggests that conflicting interests in Poland contribute to resistance against expanding protected areas. The authors recommend regional planning and collaborative learning to balance conservation with other forest uses, highlighting the importance of considering multiple perspectives and evidence-based approaches in managing this valuable natural resource.
  </article>
  <article id="keywords-article-LKE45VQV" class="keywords-article">
    <h1>Keywords</h1>
    Białowieża Forest, Transboundary Conservation, Ecotourism, Forest Protection, Wood Production, Hospitality Business
  </article>
