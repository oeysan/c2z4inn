---
title: Experiences of the Quality of the Interplay between Home-Living Young Adults
  with Serious Mental Illness and Their Social Environments
type: pub
encoding: UTF-8

---
<h1>Publication</h1>
<article id="csl-bib-container-5RUN3LX9" class="csl-bib-container">
  <div class="csl-bib-body"> <div class="csl-entry">Hovland, J.-F., Langeland, E., Ness, O., &#38; Skogvang, B. O. (2023). Experiences of the Quality of the Interplay between Home-Living Young Adults with Serious Mental Illness and Their Social Environments. <i>Issues in Mental Health Nursing</i>, <i>44</i>(8), 735. <a href="https://doi.org/10.1080/01612840.2023.2224877">https://doi.org/10.1080/01612840.2023.2224877</a></div> </div>
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-5RUN3LX9" alt="archive" class="csl-bib-button">Archive</a>
    <a href="https://app.cristin.no/results/show.jsf?id=2152886" alt="Cristin" class="csl-bib-button">Cristin</a>
    <a href="http://zotero.org/groups/5881554/items/5RUN3LX9" alt="Zotero" class="csl-bib-button">Zotero</a>
    <a href="#keywords-article-5RUN3LX9" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-5RUN3LX9" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-5RUN3LX9" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-5RUN3LX9" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
    <a href="https://www.tandfonline.com/doi/pdf/10.1080/01612840.2023.2224877?needAccess=true&amp;role=button" alt="Unpaywall" class="csl-bib-button">Unpaywall</a>
    <a href="https://www.tandfonline.com/doi/pdf/10.1080/01612840.2023.2224877?needAccess=true&amp;role=button" alt="EZproxy" class="csl-bib-button">EZproxy</a>
  </div>
  <div id="csl-bib-meta-container-5RUN3LX9"></div>
</article>
<div id="csl-bib-meta-5RUN3LX9" class="csl-bib-meta">
  <article id="about-article-5RUN3LX9" class="about_pub-article">
    <h1>About</h1>
    Hovland et al. conducted a study to understand how young adults with serious mental illness (SMI) interact with their social environments and how these interactions affect their mental health. They interviewed nine young adults and identified three main themes: feeling shame and undervalued, difficulties in maintaining relationships, and the importance of family support. The study found that while these individuals sometimes experienced positive interactions, they also faced significant challenges. The authors suggest that society needs to adopt more accepting attitudes to help individuals with SMI feel valued and included. This inclusion is crucial for improving their self-identity, reducing stigma, and enhancing overall well-being. The study highlights the importance of social support and community participation for mental health.
  </article>
  <article id="keywords-article-5RUN3LX9" class="keywords-article">
    <h1>Keywords</h1>
    Serious Mental Illness, Social Environment, Mental Health, Well-being, Social Support, Stigma
  </article>
  <article id="abstract-article-5RUN3LX9" class="abstract-article">
  ...
  <article id="contributors-article-5RUN3LX9" class="contributors-article">
    <h1>Contributors</h1>
  ...
  <article id="sdg-article-5RUN3LX9" class="sdg-article">
  ...
  <article id="taxonomy-article-5RUN3LX9" class="taxonomy-article">
    <h1>Archive</h1>
    <ul>
      <li>
