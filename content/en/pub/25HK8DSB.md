---
title: 'Hierarchies of criteria in NSO board-nomination processes: insights from nomination
  committees’ work'
type: pub
encoding: UTF-8
...
---
<h1>Publication</h1>
<article id="csl-bib-container-25HK8DSB" class="csl-bib-container">
  <div class="csl-bib-body"> <div class="csl-entry">Stenling, C., Fahlen, J., Strittmatter, A.-M., &#38; Skille, E. Å. (2019). Hierarchies of criteria in NSO board-nomination processes: insights from nomination committees’ work. <i>European Sport Management Quarterly</i>, 19. <a href="https://doi.org/10.1080/16184742.2019.1672204">https://doi.org/10.1080/16184742.2019.1672204</a></div> </div>
  <div class="csl-bib-buttons">
    <a href="#taxonomy-article-25HK8DSB" alt="archive" class="csl-bib-button">Archive</a>
    <a href="https://app.cristin.no/results/show.jsf?id=1737556" alt="Cristin" class="csl-bib-button">Cristin</a>
    <a href="http://zotero.org/groups/5881554/items/25HK8DSB" alt="Zotero" class="csl-bib-button">Zotero</a>
    <a href="#keywords-article-25HK8DSB" alt="keywords" class="csl-bib-button">Keywords</a>
    <a href="#about-article-25HK8DSB" alt="about_pub" class="csl-bib-button">About</a>
    <a href="#contributors-article-25HK8DSB" alt="contributors" class="csl-bib-button">Contributors</a>
    <a href="#sdg-article-25HK8DSB" alt="sdg" class="csl-bib-button">Sustainable Development Goals</a>
    <a href="https://www.tandfonline.com/doi/pdf/10.1080/16184742.2019.1672204?needAccess=true" alt="Unpaywall" class="csl-bib-button">Unpaywall</a>
    <a href="https://www.tandfonline.com/doi/pdf/10.1080/16184742.2019.1672204?needAccess=true" alt="EZproxy" class="csl-bib-button">EZproxy</a>
  </div>
  <div id="csl-bib-meta-container-25HK8DSB"></div>
</article>
<div id="csl-bib-meta-25HK8DSB" class="csl-bib-meta">
  <article id="about-article-25HK8DSB" class="about_pub-article">
    <h1>About</h1>
    Stenling et al. conducted a study on how nomination committees select board members for Swedish national sport organizations. They interviewed representatives from 61 committees to understand the criteria used in these selection processes. The study found that decisions are not simply about choosing between gender and merit. Instead, committees balance various criteria related to representation (like diversity) and efficiency (like skills and experience). These criteria are ranked into seven different hierarchies, with only one hierarchy prioritizing diversity. This research is important because it highlights the complexity of board selection and suggests that future studies should consider multiple criteria. It also provides insights for sport management and policy practitioners on improving representation and governance in sport organizations.
  </article>
  <article id="keywords-article-25HK8DSB" class="keywords-article">
    <h1>Keywords</h1>
    Board Selection, Governance, Representation, Sport Organizations, Nomination Committees
  </article>
  <article id="abstract-article-25HK8DSB" class="abstract-article">
...
Implications: Because rankings of multiple evaluative criteria impact any single criterion of interest (e.g. gender), future studies should take into account the range of evaluative criteria at play. For sport management and policy practitioners alike, we provide a tool to understand and address (in)adequate representation but also an imperative to consider the meaning of adequate representation.
  ...
  <article id="contributors-article-25HK8DSB" class="contributors-article">
    <h1>Contributors</h1>
  ...
  <article id="sdg-article-25HK8DSB" class="sdg-article">
  ...
  <article id="taxonomy-article-25HK8DSB" class="taxonomy-article">
    <h1>Archive</h1>
    <ul>
